...
func (in *CgroupKey) DeepCopyInto(out *CgroupKey) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CgroupKey.
func (in *CgroupKey) DeepCopy() *CgroupKey {
	if in == nil {
		return nil
	}
	out := new(CgroupKey)
...
func (in *CgroupKey) DeepCopyMapKey() bpf.MapKey {
